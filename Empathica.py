...
question_embeddings = sbert.encode(
    questions,
...
def evaluate_model(df, question_embeddings):
    ...
    predicted_labels = true_labels[best_matches]
...
evaluate_model(df, question_embeddings)
